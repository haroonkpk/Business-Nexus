...
export default function InvestorProfile() {
  ...
  if (!profile)
    return <h1 className=" w-full h-screen bg-[#0f172a] text-white text-center pt-20">Loading...</h1>;
      ...
      <div className="w-full max-w-4xl bg-white/10 backdrop-blur border border-white/20 shadow-xl rounded-2xl p-8 md:p-12">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            >
              Connect with Entrepreneurs <ArrowRight size={18} className="ml-1 md:ml-2 md:size-[23px]" />
            </motion.button>
            </Link>
          </div>
        </div>
